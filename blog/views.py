...
def index(request):
    ...
    all_stories = Contact.objects.all()
    return render(request, 'blog/stories_page.html',{'stories':all_stories})
...
def story(request):
    # check post method and request type
    all_stories = Contact.objects.all()
    return render(request, 'blog/story.html',{'stories':all_stories})
